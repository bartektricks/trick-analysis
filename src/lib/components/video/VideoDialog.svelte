			...
			<div class="space-y-6">
				...
				<div class="space-y-4">
					<div class="space-y-2">
						...
						<div class="flex items-center gap-2">
							<input
								...
								class="bg-background w-full flex-1 rounded-md border px-3 py-2 text-start text-sm" />
					...
					<Tooltip>
						...
						Optimize the video file to even out the frames in case of variable frame rate.
					</Tooltip>
